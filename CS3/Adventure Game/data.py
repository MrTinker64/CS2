...
storage_closet = Place('Storage Closet','A messy, dusty room full of shelves overflowing with pens, paper, foamcore, rulers, and old models. One of the models appears to look vaguely like a number, but you can\'t quite tell because it\'s been crushed by some scrap wood. This room is also 10 ft wide. In the back, 20 ft away, you see another door which seems to be magically free of all the dust and clutter inhabiting the rest of the room.', [])
zendo = Place('Zendo','The room is spacious, forming a 20x20 ft square. To your right is a 10x10 ft garden. The raised wooden floors are completely empty save for a small round cushion\nsitting on a mat in the corner of the room opposite the garden. Seated there you can look out the floor-to-ceiling windows onto the beautiful view outside. It feels very peaceful here.', [])
