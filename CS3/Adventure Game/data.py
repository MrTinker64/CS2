...
arch_studio = Place('Studio','Such a large space for architecture emphasizes the love Mrs. G had for it. All around there are cutting mats, sketches, and miniature buildings.\nMost of the miniature buildings seem to resemble letters of the alphabet when viewed from above.\nAbout 10 feet in front of you, in the middle of the otherwise blank wall, you see a simple wooden door with no handle.\nYou can also just make out another door, about 25 feet to your right, at the edge of studio leading in the same direction as this mysterious, handleless door.', [])
